...
Em relação ao irrigador da marca Trato, o espaço para montagem da placa é bastante reduzido, sendo limitado superiormente pelo local de parafusamento da placa e inferiormente pelo local dos botões. Em razão disso, a fim de se aproveitar o maior espaço possível, optou-se por utilizar a placa original da Trato como referência para o corte da placa de fenolite, assim como para a PCB posteriormente projetada. A imagem \ref{fig_placa_original_trato} mostra a placa original do irrigador da Trato e a imagem \ref{fig_placa_fenolite_trato} mostra a placa de fenolite cortada com os moldes da original.
...
Após os testes bem-sucedidos com a placa de fenolite, foi projetado um circuito com a plataforma EasyEDA. O esquemático é mostrado na Figura~\ref{fig:esquematico-amanco}.
...
Da mesma forma que no irrigador Trato, a PCB original do irrigador da Amanco foi utilizada como molde da placa de fenolite e da PCB para montagem dos componentes. Alguns locais onde a placa antiga era parafusada também foram aproveitados para a fixação da nova placa.
...
Após o sucesso nos testes na placa de fenolite, foi feito o projeto de uma PCB usando o EasyEDA. As posições dos componentes na placa de fenolite foram usadas como referência para o posicionamento destes na PCB.

A frente e o verso da PCB utilizada para substituir a placa antiga no irrigador Amanco são mostradas nas Figuras \ref{fig:frente_pcb_amanco} e \ref{fig:verso_pcb_amanco}, respectivamente.
