...
A fim de informar o usuário sobre o estado de funcionamento do irrigador, foram implementadas algumas indicações luminosas, realizadas através dos dois leds presentes na PCB. A Tabela~\ref{tab:status_leds} resume os tipos de indicações e seus significados.
